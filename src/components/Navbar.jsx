    ...
    return(
        <div className="absolute top-0 left-0 w-full h-[50px] overflow-hidden">
            <div className="flex justify-center items-center h-full">
                ...
                <div className={`${mobile? " bg-white fixed w-full h-[280px] top-0 z-50 items-center flex flex-col transition-all duration-500" : "h-0 w-0 transition-all duration-200"}  gap-20`}>
