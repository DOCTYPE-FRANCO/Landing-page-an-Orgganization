...
function About() {
    const executives = [
        ...
        { name: 'Orjison chukwuka Charles', image: Orjison, role: 'Member', business: 'Business' },
        ...
        { name: 'Emeka Udeogaranya', image: EmekaUdeo, role: 'Member', business: 'Business' },
        { name: 'Mr jude Duru ', image: JudeDuru, role: 'Member', business: 'Lasduru global resources ' },
        { name: 'Mr Chika Ekwunife ', image: Chika, role: 'Member', business: 'Business' },
                    ...
                    {executives.map((executive, index) => (
                        <motion.div
                            ...
                            <div className="flex flex-col gap-8 justify-center items-center">
                                <h3 className="text-lg font-bold text-center">{executive.name.toLocaleUpperCase()}</h3>
